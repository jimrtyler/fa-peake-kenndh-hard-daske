...
#GUI Variables
$FormTitleText = "پاک کننده دیسک توسط جیم تایلر (PowerShellEngineer.com)"
$SelectDiskLabelText = "انتخاب دیسک:"
$FreeSpaceLabelText = "فضای آزاد (گیگابایت):"
$TotalSpaceLabelText = "فضای کل (گیگا بایت):"
$JunkFoundLabelText = "آشغال پیدا شده (گیگا بایت):"
$CleanDiskBtnText = "پاک کردن دیسک *حذف فایل ها*"
$SpaceCleanedLabelText = "فضای پاک شده (گیگابایت):"
$LogFileLabelText = "فایل گزارش پیدا شد: $abcdefg"
$CreditLabelText = "اسکریپت توسط جیم تایلر - PowerShellEngineer.com"
$LogFileLocatedText = "فایل گزارش پیدا شد"
$AnalyzingDriveText = "در حال تجزیه و تحلیل درایوها..."
$BrowsersAreRunningText = "مرورگرها در حال اجرا هستند... به کاربر اطلاع دهید..."
$PleaseCloseBrowsersText = "لطفاً همه مرورگرهای وب را ببندید و دوباره امتحان کنید."
$CleaningDriveText = "تمیز کردن درایو..."
